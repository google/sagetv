...
#define sage_Sage_REQUIRE_WIN32_LAUNCHER 0L
#undef sage_Sage_DISABLE_MSG_LOOP_FOR_JPROFILER
#define sage_Sage_DISABLE_MSG_LOOP_FOR_JPROFILER 0L
#undef sage_Sage_FLASH_STORAGE
#define sage_Sage_FLASH_STORAGE 0L
#undef sage_Sage_ENABLE_APP_EXPIRE
#define sage_Sage_ENABLE_APP_EXPIRE 0L
#undef sage_Sage_APP_EXPIRE_TIME
#define sage_Sage_APP_EXPIRE_TIME 4611686018427387903i64
#undef sage_Sage_CLIENT_COMPATIBLE_MAJOR_VERSION
#define sage_Sage_CLIENT_COMPATIBLE_MAJOR_VERSION 7L
#undef sage_Sage_CLIENT_COMPATIBLE_MINOR_VERSION
#define sage_Sage_CLIENT_COMPATIBLE_MINOR_VERSION 1L
#undef sage_Sage_CLIENT_COMPATIBLE_MICRO_VERSION
#define sage_Sage_CLIENT_COMPATIBLE_MICRO_VERSION 3L
#undef sage_Sage_ENCODER_COMPATIBLE_MAJOR_VERSION
#define sage_Sage_ENCODER_COMPATIBLE_MAJOR_VERSION 4L
#undef sage_Sage_ENCODER_COMPATIBLE_MINOR_VERSION
#define sage_Sage_ENCODER_COMPATIBLE_MINOR_VERSION 1L
#undef sage_Sage_ENCODER_COMPATIBLE_MICRO_VERSION
#define sage_Sage_ENCODER_COMPATIBLE_MICRO_VERSION 0L
...
#define sage_Sage_DOS_BYTE_LIMIT 10000000L
...
#undef sage_Sage_MEM_USAGE_FOR_GC
#define sage_Sage_MEM_USAGE_FOR_GC 0.8f
#undef sage_Sage_MEM_USAGE_FOR_FULL_GC
#define sage_Sage_MEM_USAGE_FOR_FULL_GC 0.95f
...
#undef sage_Sage_SEEK_FILE_MSG
#define sage_Sage_SEEK_FILE_MSG 9L
#undef sage_Sage_STOP_FILE_MSG
#define sage_Sage_STOP_FILE_MSG 10L
#undef sage_Sage_RESIZE_VIDEO_MSG
#define sage_Sage_RESIZE_VIDEO_MSG 11L
#undef sage_Sage_SIGNAL_STRENGTH_MSG
#define sage_Sage_SIGNAL_STRENGTH_MSG 12L
#undef sage_Sage_AUTOSCAN_MSG
#define sage_Sage_AUTOSCAN_MSG 13L
#undef sage_Sage_AUTOSCAN_MSG_INFO
#define sage_Sage_AUTOSCAN_MSG_INFO 14L
#undef sage_Sage_SETUPHOOKS_MSG
#define sage_Sage_SETUPHOOKS_MSG 15L
/*
 * Class:     sage_Sage
 ...
 * Signature: (ILjava/lang/String;)[Ljava/lang/String;
 */
JNIEXPORT jobjectArray JNICALL Java_sage_Sage_getRegistrySubkeys
  (JNIEnv *, jclass, jint, jstring);
...
/*
 * Class:     sage_Sage
 * Method:    getMACAddress0
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_sage_Sage_getMACAddress0
  (JNIEnv *, jclass);
 ...
 * Signature: (IIIIIII)V
 */
JNIEXPORT void JNICALL Java_sage_Sage_setSystemTime
