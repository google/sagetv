...
class SampleGroup;
class CDeMuxOutputPin : public CBaseOutputPin
{
	friend class CDeMuxFilter;
public:
    CDeMuxOutputPin( CDeMuxFilter *pFilter, HRESULT *phr, LPCWSTR pName, 
	...
	HRESULT SendSample( const BYTE *pbData, LONG lData, REFERENCE_TIME rtStart, REFERENCE_TIME rtStop, BOOL bSync );
...
private:
    ...
    {
		DbgLog((LOG_TRACE, 1, TEXT("Notified Quality Mesage")));
        return E_FAIL;
    }
	...
	CGenericList<_BLOCK> m_lGroupList;
