...
HRESULT
CAsyncIo::Length(LONGLONG *pllTotal, LONGLONG* pllAvailable, LONGLONG* pllOverwritten)
{
    *pllTotal = m_pStream->Size(pllAvailable, pllOverwritten);
    return S_OK;
}
