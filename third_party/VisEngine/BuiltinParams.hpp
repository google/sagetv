...
public:
   typedef std::map<std::string, std::string> AliasMap;
    ...
    int load_builtin_param_mathtype( const std::string & name, void *engine_val, void *matrix,
                                  short int flags,
                                  mathtype init_val, mathtype upper_bound,
                                  mathtype lower_bound, const std::string & alt_name );
