 ...
 */
/**
 * $Id: Expr.hpp,v 1.1 2009-09-17 14:26:03 jeanfrancois Exp $
 *
 * Expression
 *
 * $Log: Expr.hpp,v $
...
{
public:
  mathtype constant; /* static variable */
...
public:
  ...
  mathtype eval_gen_expr(int mesh_i, int mesh_j);
 
  static GenExpr *const_to_expr( mathtype val );
  static GenExpr *param_to_expr( Param *param );
  static GenExpr *prefun_to_expr( mathtype (*func_ptr)(void *), GenExpr **expr_list, int num_args );
};
...
public:
  ...
  mathtype eval_val_expr(int mesh_i, int mesh_j);
};
...
public:
  ...
  mathtype eval_tree_expr(int mesh_i, int mesh_j);
};
...
public:
  ...
  mathtype eval_prefun_expr(int mesh_i, int mesh_j);
