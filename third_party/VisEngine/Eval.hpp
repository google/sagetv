 ...
 */
/**
 * $Id: Eval.hpp,v 1.1 2009-09-17 14:26:03 jeanfrancois Exp $
 *
...
public:
    ...
    mathtype eval_gen_expr(GenExpr * gen_expr);
    inline GenExpr * opt_gen_expr(GenExpr * gen_expr, int ** param_list);

    GenExpr * const_to_expr(mathtype val);
    GenExpr * param_to_expr(Param * param);
    GenExpr * prefun_to_expr(mathtype (*func_ptr)(), GenExpr ** expr_list, int num_args);
