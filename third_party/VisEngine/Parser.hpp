 ...
 */
/**
 * $Id: Parser.hpp,v 1.1 2009-09-17 14:26:03 jeanfrancois Exp $
 *
 * Preset parser
 *
 * $Log: Parser.hpp,v $
...
public:
    ...
    static int parse_mathtype(std::istream & fs, mathtype * mathtype_ptr);
    ...
    static int string_to_mathtype(char * string, mathtype * mathtype_ptr);
