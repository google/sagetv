...
/**
 * Abstract base class for all directory implementations, having methods for
 * getting and setting tag values of various data types.
 */
public abstract class Directory implements Serializable {
    ...
    /**
     * Returns the specified tag's value as an int, if possible. Every attempt
     * to represent the tag's value as an int is taken. Here is a list of the
     * action taken depending upon the tag's original type:
     * <ul>
     ...
     * <li> String - Attempt to parse string as an int. If this fails, convert
     * the char[] to an int (using shifts and OR).
    ...
    public int getInt(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
    ...
    public String[] getStringArray(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to an String array.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public int[] getIntArray(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to an int array.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public byte[] getByteArray(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a byte array.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public double getDouble(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a double.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public float getFloat(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a float.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public long getLong(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a long.  It is of type '" + o.getClass()
                + "'.");
    }
    ...
    public boolean getBoolean(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a boolean.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public java.util.Date getDate(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a java.util.Date.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public Rational getRational(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a Rational.  It is of type '"
                + o.getClass() + "'.");
    }
    ...
    public Rational[] getRationalArray(int tagType) throws MetadataException {
        ...
        throw new MetadataException("Tag '" + tagType
                + "' cannot be cast to a Rational array.  It is of type '"
                + o.getClass() + "'.");
    }
