...
{
    public static final int JPEG_FILE_MAGIC_NUMBER = 0xFFD8;
    public static final int MOTOROLLA_TIFF_MAGIC_NUMBER = 0x4D4D;  // "MM"
    public static final int INTEL_TIFF_MAGIC_NUMBER = 0x4949;      // "II"
    ...
    public static int readMagicNumber(BufferedInputStream inputStream) throws ImageProcessingException
    {
        int magicNumber;
        try {
            inputStream.mark(2);
