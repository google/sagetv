 ...
 * @author  Narflex
 */
public class IVTVBroadcastCaptureDevice extends IVTVCaptureDevice
{
  ...
  public IVTVBroadcastCaptureDevice()
  {
    super();
  }
  public IVTVBroadcastCaptureDevice(int inID) throws java.net.UnknownHostException
  {
    super(inID);
  ...
  public void run()
  {
    ...
    if (Sage.DBG) System.out.println("Starting IVTV Broadcast capture thread");
    long addtlBytes = 0;
    ...
    while (!stopCapture)
    {
      ...
      if (logCapture)
        System.out.println("IVTVCap " + recFilename + " " + currRecordedBytes);
    }
    closeEncoding0(pHandle);
    if (Sage.DBG) System.out.println("IVTV capture thread terminating");
    try
    {
