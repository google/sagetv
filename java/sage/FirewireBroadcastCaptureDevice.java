 ...
 */
public class FirewireBroadcastCaptureDevice extends FirewireCaptureDevice
{
  ...
  public FirewireBroadcastCaptureDevice()
  {
    super();
  }
  public FirewireBroadcastCaptureDevice(int inID) throws java.net.UnknownHostException
  {
    super(inID);
  ...
  public void run()
  {
    ...
    if (Sage.DBG) System.out.println("Starting Firewire Broadcast capture thread");
    long addtlBytes = 0;
