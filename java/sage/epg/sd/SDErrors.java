...
public enum SDErrors
{
  ...
  USERAGENT_REQUIRED(1003 /*, "Did not receive User-Agent in header."*/),
  TOKEN_MISSING(1004 /*, "Token required but not provided in request header."*/),
  UNKNOWN_CLIENT(1005 /*, "Did not recognize the submitted client."*/),
  MAX_CHUNK_EXCEEDED(1006 /*, "The maximum number of elements in a single request is 5000."*/),
  EMPTY_REQUEST(1007 /*, "The request sent to the server was empty."*/),
  INCORRECT_REQUEST(1008 /*, "The request is improperly formatted."*/),
  MAX_CHUNK_EXCEEDED_500(1009 /*, "The maximum number of elements in a single request is 500."*/),
  TOKEN_INVALID(1010 /*, "Token is not 32 characters."*/),
  INCORRECT_CONTENT_TYPE(1011 /*, "The Content-Type header must be application/json."*/),
  ...
  REQUIRED_PARAMETER_MISSING_PERSONID(2020 /*, "Request is missing the personID / namedID in the path."*/),
  ...
  INVALID_PARAMETER_UNKNOWN_REQUEST(2054 /*, "Your client may request available data for: COUNTRIES"*/),
  ...
  INVALID_PERSONID(2109 /*, "The personId you requested does not exist."*/),
  STATIONID_NOT_FOUND(2200 /*, "The stationID you requested is not in any of your lineups."*/),
  STATIONID_DELETED(2201 /*, "The stationID you requested has been marked as deleted and will be purged."*/),
  SERVICE_OFFLINE(3000 /*, "Server offline for maintenance."*/),
  SERVER_BUSY(3001 /*, "Server is busy processing other requests. Retry."*/),
  ...
  APPLICATION_DISABLED(4007 /*, "Application not authorized to use data service."*/),
  ACCOUNT_INACTIVE(4008 /*, "Account inactive."*/),
  TOO_MANY_LOGINS(4009 /*, "Exceeded maximum number of logins in 24 hours."*/),
  TOO_MANY_UNIQUE_IPS(4010 /*, "Exceeded maximum number of unique IP addresses in 24 hours."*/),
  ...
  MAX_IMAGE_INVALID_URI_ERRORS(5004 /*, "Exceeded maximum number of invalid image URIs in 24 hours."*/),
