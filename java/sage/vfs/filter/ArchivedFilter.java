 ...
 * @author Narflex
 */
public class ArchivedFilter extends BasicDataObjectFilter
{

  /**
   * Creates a new instance of ArchivedFilter
   */
  public ArchivedFilter(boolean matchPasses)
  {
    super(matchPasses);
  }
  ...
  {
    return MediaNode.FILTER_ARCHIVED;
  }

  // Pretty version which is presented to the user
  public String getName()
  {
    return sage.Sage.rez("Archived");
  }
  ...
  public boolean passesFilter(String dataType, Object data)
  {
    ...
    return (mf != null && (mf.isArchiveFile() == matchPasses));
  }
}
