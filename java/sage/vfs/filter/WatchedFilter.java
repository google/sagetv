 ...
 * @author Narflex
 */
public class WatchedFilter extends BasicDataObjectFilter
{

  /**
   * Creates a new instance of WatchedFilter
   */
  public WatchedFilter(boolean matchPasses)
  {
    super(matchPasses);
  }
  ...
  {
    return MediaNode.FILTER_WATCHED;
  }

  // Pretty version which is presented to the user
  public String getName()
  {
    return sage.Sage.rez("Watched");
  }
  ...
  public boolean passesFilter(String dataType, Object data)
  {
    ...
    return (air != null && (air.isWatched() == matchPasses));
  }
}
