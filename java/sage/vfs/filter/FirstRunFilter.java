 ...
 * @author Narflex
 */
public class FirstRunFilter extends BasicDataObjectFilter
{

  /**
   * Creates a new instance of FirstRunFilter
   */
  public FirstRunFilter(boolean matchPasses)
  {
    super(matchPasses);
  }
  ...
  {
    return MediaNode.FILTER_FIRSTRUN;
  }

  // Pretty version which is presented to the user
  public String getName()
  {
    return sage.Sage.rez("First Run");
  }
  ...
  public boolean passesFilter(String dataType, Object data)
  {
    ...
    return (air != null && (air.isFirstRun() == matchPasses));
  }
}
