 ...
 * @author Narflex
 */
public class FavoriteFilter extends BasicDataObjectFilter
{

  /**
   * Creates a new instance of FavoriteFilter
   */
  public FavoriteFilter(boolean matchPasses)
  {
    super(matchPasses);
  }
  ...
  {
    return MediaNode.FILTER_FAVORITE;
  }

  // Pretty version which is presented to the user
  public String getName()
  {
    return sage.Sage.rez("Favorite");
  }
  ...
  public boolean passesFilter(String dataType, Object data)
  {
    ...
    return (air != null && (Carny.getInstance().isLoveAir(air) == matchPasses));
  }
}
