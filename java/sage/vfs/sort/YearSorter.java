 ...
 * @author Narflex
 */
public class YearSorter extends BasicMediaNodeSorter
{
  /** Creates a new instance of YearSorter */
  ...
  public int compare(Object o1, Object o2)
  {
    ...
    String s1 = (a1 == null) ? m1.getPrimaryLabel() : a1.getYear();
    String s2 = (a2 == null) ? m2.getPrimaryLabel() : a2.getYear();
    return (ascending ? 1 : -1) * s1.compareToIgnoreCase(s2);
  }

  public String getTechnique()
  {
    return MediaNode.SORT_BY_YEAR;
  }

  public String getName()
  {
    return sage.Sage.rez("Year");
  }
}
