 ...
 * @author Narflex
 */
public class FullpathSorter extends BasicMediaNodeSorter
{

	/** Creates a new instance of FullpathSorter */
	public FullpathSorter(boolean ascending)
	{
		super(ascending);
	}
	...
	public int compare(Object o1, Object o2)
	{
		...
		if (MediaNode.DATATYPE_FILE.equals(m1.getDataType()))
			s1 = ((java.io.File) m1.getDataObject()).getAbsolutePath();
		else if (MediaNode.DATATYPE_MEDIAFILE.equals(m1.getDataType()))
			s1 = ((sage.MediaFile) m1.getDataObject()).getFile(0).getAbsolutePath();
		else
			s1 = m1.getPrimaryLabel();
		if (MediaNode.DATATYPE_FILE.equals(m2.getDataType()))
			s2 = ((java.io.File) m2.getDataObject()).getAbsolutePath();
	...
	{
		return MediaNode.SORT_BY_FULL_PATH;
	}

	public String getName()
	{
		return sage.Sage.rez("Fullpath");
	}
}
