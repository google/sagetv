 ...
 * @author Narflex
 */
public class RatingSorter extends BasicMediaNodeSorter
{
  /** Creates a new instance of RatingSorter */
  public RatingSorter(boolean ascending)
  {
    super(ascending);
  }
  ...
  public int compare(Object o1, Object o2)
  {
    ...
    String s1 = (a1 == null) ? "" : a1.getRating();
    String s2 = (a2 == null) ? "" : a2.getRating();
    return (ascending ? 1 : -1) * s1.compareToIgnoreCase(s2);
  }

  public String getTechnique()
  {
    return MediaNode.SORT_BY_RATING;
  }

  public String getName()
  {
    return sage.Sage.rez("Rating");
  }
}
