 ...
 * @author Narflex
 */
public class RatedSorter extends BasicMediaNodeSorter
{
  /** Creates a new instance of RatedSorter */
  public RatedSorter(boolean ascending)
  {
    super(ascending);
  }
  ...
  {
    return MediaNode.SORT_BY_RATED;
  }

  public String getName()
  {
    return sage.Sage.rez("Rated");
  }
}
