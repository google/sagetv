 ...
 * @author Narflex
 */
public class ChannelNameSorter extends BasicMediaNodeSorter
{
  /** Creates a new instance of ChannelNameSorter */
  public ChannelNameSorter(boolean ascending)
  {
    super(ascending);
  }
  ...
  public int compare(Object o1, Object o2)
  {
    ...
    String s1 = (a1 == null) ? m1.getPrimaryLabel() : a1.getChannelName();
    String s2 = (a2 == null) ? m2.getPrimaryLabel() : a2.getChannelName();
    return (ascending ? 1 : -1) * s1.compareToIgnoreCase(s2);
  }

  public String getTechnique()
  {
    return MediaNode.SORT_BY_CHANNEL_NAME;
  }

  public String getName()
  {
    return sage.Sage.rez("Channel Name");
  }
}
