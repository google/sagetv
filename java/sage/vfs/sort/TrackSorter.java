 ...
 * @author Narflex
 */
public class TrackSorter extends BasicMediaNodeSorter
{
  /** Creates a new instance of TrackSorter */
  public TrackSorter(boolean ascending)
  {
    super(ascending);
  }
  ...
  public int compare(Object o1, Object o2)
  {
    ...
    int t1 = (a1 == null) ? 0 : a1.getTrack();
    int t2 = (a2 == null) ? 0 : a2.getTrack();
    if (t1 < t2)
  ...
  {
    return MediaNode.SORT_BY_TRACK;
  }

  public String getName()
  {
    return sage.Sage.rez("Track");
  }
}
