 ...
 * @author Narflex
 */
public class EpisodeIDSorter extends BasicMediaNodeSorter
{
  /**
   * Creates a new instance of EpisodeIDSorter
   */
  public EpisodeIDSorter(boolean ascending)
  {
    super(ascending);
  }
  ...
  {
    return MediaNode.SORT_BY_EPISODE_ID;
  }

  public String getName()
  {
    return sage.Sage.rez("Episode ID");
  }
}
